...
// Tue Apr 28 14:22:33 2026 by ROOT version 6.36.10
// from TTree mini/mini
// found on file: /mnt/share/physics_data/4lep/MC/mc_345060.ggH125_ZZ4lep.4lep.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/share/physics_data/4lep/MC/mc_345060.ggH125_ZZ4lep.4lep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/mnt/share/physics_data/4lep/MC/mc_345060.ggH125_ZZ4lep.4lep.root");
      }
